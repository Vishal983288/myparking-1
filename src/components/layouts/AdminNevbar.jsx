...
import Parkingmenu from "../../assets/logo2.png";
import { Link } from "react-router-dom";
import "bootstrap-icons/font/bootstrap-icons.css";


export const AdminNevbar = ({ toggleSidebar }) => {
  return (
      ...
      <div className="container-fluid">
        <ul className="navbar-nav">
          <li className="nav-item">
            ...
            >
              <img src={Parkingmenu} style={{height:"25px",width:"25px"}}></img>
            </a>
          </li>
              ...
              <a href="#" className="dropdown-item">
                <div className="d-flex">
                  ...
                  <div className="flex-grow-1">
                    ...
                    <p className="fs-7">Call me if Mendetory you can...</p>
              ...
              <a href="#" className="dropdown-item">
                ...
                <div className="d-flex">
                  ...
                  <div className="flex-grow-1">
                    ...
                    <p className="fs-7">I got your message</p>
                    <p className="fs-7 text-secondary">
                      <i className="bi bi-clock-fill me-1" /> 4 Hours Ago
                    </p>
                  </div>
          ...
          <li className="nav-item dropdown user-menu">
            ...
            <ul className="dropdown-menu dropdown-menu-lg dropdown-menu-end">
              ...
              <li className="user-footer">
                ...
                <Link to="login" className="btn btn-default btn-flat float-end">
                  Sign out
                </Link>
              </li>
            </ul>
